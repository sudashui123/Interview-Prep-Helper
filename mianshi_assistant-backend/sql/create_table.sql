...
values
    ('Java基础题库', '收录Java语法、面向对象、异常处理等核心知识点，适合初学者和面试准备者。', null, 1),
    ('数据结构题库', '包含链表、栈、队列、树、图等常见数据结构的高频题。', null, 2),
    ('操作系统题库', '覆盖进程、线程、内存管理、死锁等操作系统重要概念。', null, 1),
    ('计算机网络题库', '涵盖 TCP/IP、HTTP、HTTPS、DNS、OSI 七层模型等内容。', null, 3),
    ('数据库题库', '涵盖SQL语法、事务、索引优化、范式、锁机制等数据库知识点。', null, 2);
