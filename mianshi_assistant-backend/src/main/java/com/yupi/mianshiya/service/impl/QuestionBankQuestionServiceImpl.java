...
//        }
    ...
    public void batchAddQuestionsToBank(List<Long> questionIdList, long questionBankId, User loginUser) {
        ...
        //使用lambda查询减少 select *的使用,
        // Question对象转换成 Long类型减少内存占用
...
//                .collect(Collectors.toList());
        ...
        for (int i = 0; i < totalQuestionListSize; i += batchSize) {
            ...
            //this.batchAddQuestionToBankInner(questionBankQuestions); 这样处理事务不会生效，在spring里
    ...
    public  void batchAddQuestionsToBankInner(List<QuestionBankQuestion> questionBankQuestions){
        ...
        try {
            //使用批处理 提交任务，减少与数据库的交互this.saveBatch(questionBankQuestions)
    ...
    public void batchRemoveQuestionsFromBank(List<Long> questionIdList, long questionBankId) {
        ...
        for (long questionId : questionIdList) {
            ...
            ThrowUtils.throwIf(result, ErrorCode.PARAMS_ERROR, "向题库批量移除题目失败");
