...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getUserSignIn(Integer yaer, HttpServletRequest request) {
        //必须登录才能签到
        User loginUser = userService.getLoginUser(request);
        List<Integer> userSignInRecord = userService.getUserSignInRecord(loginUser.getId(), yaer);
